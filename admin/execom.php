	...
	<?php include('includes/leftbar.php');?>
		<div class="content-wrapper">
			<div class="container-fluid">
				<!-- <div class="row">
					<div class="col-md-12">
						<h3 class="page-title">Edit Execom</h3>
						<div class="row">
							<div class="col-md-12">
...
<!-- <form action="edit-execom.php" method="post" class="form-horizontal" enctype="multipart/form-data"> -->
...
<?php if($error){?><div class="errorWrap"><strong>ERROR</strong>:<?php echo htmlentities($error); ?> </div><?php } 
									...
									<div class="panel-body">
<form action="update-execom.php" method="post" class="form-horizontal" enctype="multipart/form-data">
<!-- <div class="form-group">
<label class="col-sm-2 control-label">Search ID<span style="color:red">*</span></label>
<div class="col-sm-4">
<input type="text" name="name" class="form-control" placeholder="User ID">
